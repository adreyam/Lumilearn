...
// Synthétiseur de sons avec Web Audio API
let audioCtx = null;
...
function playSound(type) {
    ...
    if (type === "click") {
        ...
        osc.type = "triangle";
        osc.frequency.setValueAtTime(523.25, now); // Do 5 (C5)
        osc.frequency.setValueAtTime(659.25, now + 0.1); // Mi 5 (E5)
...
// Catégories de cartes - Paire Image (emoji) et Texte (nom de l'animal)
const animalPairs = [
    { text: "🐶", matchId: 1, type: "emoji" }, { text: "Chien", matchId: 1, type: "text" },
    { text: "🐱", matchId: 2, type: "emoji" }, { text: "Chat", matchId: 2, type: "text" },
    { text: "🦁", matchId: 3, type: "emoji" }, { text: "Lion", matchId: 3, type: "text" },
    { text: "🐻", matchId: 4, type: "emoji" }, { text: "Ours", matchId: 4, type: "text" },
    { text: "🐼", matchId: 5, type: "emoji" }, { text: "Panda", matchId: 5, type: "text" },
    { text: "🐸", matchId: 6, type: "emoji" }, { text: "Grenouille", matchId: 6, type: "text" },
    { text: "🦊", matchId: 7, type: "emoji" }, { text: "Renard", matchId: 7, type: "text" },
    { text: "🐙", matchId: 8, type: "emoji" }, { text: "Poulpe", matchId: 8, type: "text" }
];
